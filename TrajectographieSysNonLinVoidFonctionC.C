...
double p1[5],p2[5],p3[5],p4[5];
double MyFunc1 (double *x) {
return ( (4*pow(x[1]*sqrt(pow(x[2]*p1[0]-p1[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p1[0]-p1[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p1[2]-p1[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p1[2]-p1[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p1[4] );
}

double MyFunc3 (double *x) {
return ( (4*pow(x[1]*sqrt(pow(x[2]*p3[0]-p3[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p3[0]-p3[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p3[2]-p3[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p3[2]-p3[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p3[4] );
}

double MyFunc2 (double *x) {
return ( (4*pow(x[1]*sqrt(pow(x[2]*p2[0]-p2[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p2[0]-p2[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p2[2]-p2[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p2[2]-p2[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p2[4] );
}

double MyFunc4 (double *x) {
return ( (4*pow(x[1]*sqrt(pow(x[2]*p4[0]-p4[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p4[0]-p4[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p4[2]-p4[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p4[2]-p4[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p4[4] );
}	
...
p1={ x10,  y10, x9, y9, t10[eve]-t9[eve]};
p2={ x10,  y10, x7, y7, t10[eve]-t7[eve]};
p3={ x10,  y10, x3, y3, t10[eve]-t3[eve]};
p4={ x10,  y10, x0, y0, t10[eve]-t0[eve]};
cout << " Coucou 7 " << endl;
// wrap the functions
ROOT::Math::WrappedMultiFunction g1(*MyFunc1, 4);
ROOT::Math::WrappedMultiFunction g2(*MyFunc2, 4);
ROOT::Math::WrappedMultiFunction g3(*MyFunc3, 4);
ROOT::Math::WrappedMultiFunction g4(*MyFunc4, 4);
