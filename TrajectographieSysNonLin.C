...
TF1 * MyFunc1 = new TF1("MyFunc1", MyFunc1, 0, 0, 5);
TF1 * MyFunc2 = new TF1("MyFunc2", MyFunc2, 0, 0, 5);
TF1 * MyFunc3 = new TF1("MyFunc3", MyFunc3, 0, 0, 5);
TF1 * MyFunc4 = new TF1("MyFunc4", MyFunc4, 0, 0, 5);
