...
return ( (4*pow(x[1]*sqrt(pow(x[2]*p1[0]-p1[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p1[0]-p1[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p1[2]-p1[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p1[2]-p1[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p1[5] );
}

double MyFunc3 (double *x, double *p3 ) {
return ( (4*pow(x[1]*sqrt(pow(x[2]*p3[0]-p3[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p3[0]-p3[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p3[2]-p3[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p3[2]-p3[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p3[5] );
}

double MyFunc2 (double *x, double *p2 ) {
return ( (4*pow(x[1]*sqrt(pow(x[2]*p2[0]-p2[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p2[0]-p2[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p2[2]-p2[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p2[2]-p2[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p2[5] );
}

double MyFunc4 (double *x, double *p4 ) {
return ( (4*pow(x[1]*sqrt(pow(x[2]*p4[0]-p4[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p4[0]-p4[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p4[2]-p4[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p4[2]-p4[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p4[5] );
}	
...
cout << " Coucou 5 " << endl;
TF1 * MyFunc1 = new TF1("MyFunc1", (4*pow(x[1]*sqrt(pow(x[2]*p1[0]-p1[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p1[0]-p1[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p1[2]-p1[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p1[2]-p1[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p1[5], 0, 100, 5);
TF1 * MyFunc2 = new TF1("MyFunc2", (4*pow(x[1]*sqrt(pow(x[2]*p3[0]-p3[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p3[0]-p3[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p3[2]-p3[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p3[2]-p3[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p3[5], 0, 100, 5);
TF1 * MyFunc3 = new TF1("MyFunc3", (4*pow(x[1]*sqrt(pow(x[2]*p2[0]-p2[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p2[0]-p2[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p2[2]-p2[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p2[2]-p2[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p2[5], 0, 100, 5);
TF1 * MyFunc4 = new TF1("MyFunc4", (4*pow(x[1]*sqrt(pow(x[2]*p4[0]-p4[1]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p4[0]-p4[1]+x[3],2))/sqrt(1+pow(x[2],2)))-(4*pow(x[1]*sqrt(pow(x[2]*p4[2]-p4[3]+x[3],2))/sqrt(1+pow(x[2],2)),2)+4*x[0]*x[1]*sqrt(pow(x[2]*p4[2]-p4[3]+x[3],2))/sqrt(1+pow(x[2],2)))-4*x[1]*p4[5], 0, 100, 5);
